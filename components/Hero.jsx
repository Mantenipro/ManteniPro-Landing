export default function Hero() {
  return (
    <div className='flex flex-col justify-center'>
      ...
      <div className='flex flex-wrap justify-center flex-row gap-[1rem] mt-[-9rem] md:mt-[-18rem] lg:mt-[-14rem]'>
        <div className="flex md:hidden">
            <img className='z-10  w-[400px] h-[600px]' src="/mobilehero.png" alt="" />
        </div>
